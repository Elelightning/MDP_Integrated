...
- receives images from RPi and process them
- detects symbols present in each image and output their bounding boxes and class ids
- sends symbols' class ids back to RPi
- displays all images with bounding boxes at the end of exploration

- Python version: 3.7.4

- instructions given are based on Linux (Ubuntu) machine
...
- activate the virtual environment: `source venv/bin/activate`
  - alternatively on Windows type inclusive of quotes: `"C:\.\image_processing_server\venv\Scripts\activate"`
...
- once done, you can deactivate the virtual environment: `deactivate`
  - alternatively on Windows type inclusive of quotes: `"C:\...\image_processing_server\venv\Scripts\deactivate"`
